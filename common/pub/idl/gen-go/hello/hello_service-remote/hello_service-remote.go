...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  HelloRes GetHello(HelloReq req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	case "GetHello":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "GetHello requires 1 args")
			flag.Usage()
		}
		arg4 := flag.Arg(1)
		...
		value0 := argvalue0
		fmt.Print(client.GetHello(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
