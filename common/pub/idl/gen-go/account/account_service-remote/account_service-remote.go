...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  LogInRes UserLogIn(LogInReq req)")
	fmt.Fprintln(os.Stderr, "  LogOutRes UserLogOut(LogOutReq req)")
	fmt.Fprintln(os.Stderr, "  RegisterRes UserRegister(RegisterReq req)")
	fmt.Fprintln(os.Stderr, "  ChangePwRes UserChangePw(ChangePwReq req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	case "UserLogIn":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "UserLogIn requires 1 args")
			flag.Usage()
		}
		arg10 := flag.Arg(1)
		...
		value0 := argvalue0
		fmt.Print(client.UserLogIn(value0))
		fmt.Print("\n")
		break
	case "UserLogOut":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "UserLogOut requires 1 args")
			flag.Usage()
		}
		arg16 := flag.Arg(1)
		...
		argvalue0 := account.NewLogOutReq()
		...
		value0 := argvalue0
		fmt.Print(client.UserLogOut(value0))
		fmt.Print("\n")
		break
	case "UserRegister":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "UserRegister requires 1 args")
			flag.Usage()
		}
		arg22 := flag.Arg(1)
		...
		argvalue0 := account.NewRegisterReq()
		...
		value0 := argvalue0
		fmt.Print(client.UserRegister(value0))
		fmt.Print("\n")
		break
	case "UserChangePw":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "UserChangePw requires 1 args")
			flag.Usage()
		}
		arg28 := flag.Arg(1)
		...
		argvalue0 := account.NewChangePwReq()
		...
		value0 := argvalue0
		fmt.Print(client.UserChangePw(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
